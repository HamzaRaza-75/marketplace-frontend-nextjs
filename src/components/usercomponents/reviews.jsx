...
const Reviews = () => {
    return (
        <>
            <div className="flex py-2 flex-col gap-3 w-[40vw] shadow-2xl">
                <div className="flex flex-col gap-4 p-4 bg-white">
                    <div className="flex justify-between justify">
                        <div className="flex justify-between w-full">
                            <div className='flex gap-2'>
                                <div className="text-center text-white rounded-full w-7 h-7 bg-cyan-700">J</div>
                    ...
                    <div className="flex justify-between">
                        <span className='px-4 py-2 font-semibold text-white rounded-full bg-cyan-600'>Feb 13, 2021</span>
                    </div>
                </div>
            </div>
        </>
