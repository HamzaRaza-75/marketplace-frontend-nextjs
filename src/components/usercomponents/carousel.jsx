  ...
  return (
      <div className='relative overflow-hidden'>
          ...
          <div className="absolute inset-0 flex items-center justify-between p-4">
              <button onClick={prev} className='p-1 text-gray-800 rounded-full shadow bg-white/80 hover:bg-white'>
                  <IoArrowBackCircleSharp />
              </button>
              <button onClick={next} className='p-1 text-gray-800 rounded-full shadow bg-white/80 hover:bg-white'>
